...
import recommendsCard from './assets/production/images/card_recommends.png';
...
export const projects = [
	{
		...
		projectDescription:
			"A fully responsive, interactive branded web project for SweetWater Brewery. The site redesign replaced the Brewery's outdated site and better captures its brand voice.",
	...
	},
	{
		...
		projectDescription: (
			<span>
				Analyze was built to replace the handwritten datasheets and graphs used
				by behavioral therapists who work with children with Autism. Therapists
				can use Analyze to track and update therapy session records and see a
				child's progress graphed automatically over time.<br />
				<br /> This project was built with React and Backbone with a Parse API
				backend. I used Chart.js to graph the behavioral data and Sketch to
				design the app. <br />
				<br /> Analyze was an ambitious project that I coded in two weeks to
				fulfill the requirements of my Front-end Engineering Course at the Iron
				Yard. Follow the link below and login using the username and password{' '}
...
export const projectFirst = [
	{
		id: 1,
		projectTitle: 'Recommends App',
		projectLink: 'https://dry-ravine-65975.herokuapp.com',
		projectCategory: 'Node/React + Redux App',
		cardImage: recommendsCard
	}
];
